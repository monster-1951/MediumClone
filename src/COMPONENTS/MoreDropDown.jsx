      ...
      {isOpen && (
        <div className="shadow-2xl rounded-sm overflow-hidden bg-white w-40 z-10">
          <ul className="p-3 space-y-3 flex flex-col z-10 bg-white ">
            <NavLink  className="flex space-x-4 hover:text-xl" to="/MediumClone/Write"><button onClick={() => {
            ...
            <NavLink className="flex space-x-4 hover:text-xl text-red-600" to="/MediumClone/Stories/Published/DeletePost"><button>
